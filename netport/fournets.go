...
var FourNets = NetDevs{
	{
		...
		Remotes: []string{"10.1.0.2", "10.6.6.6",
			"2002:db8:85a3::370:0001", "3333:db8:85a3::370:0001"},
	},
	{
		NetPort: "net0port1",
		Netns:   "r",
	...
	},
	{
		...
		Netns:   "h2",
		Ifa:     "10.1.0.2/31",
		Ifas: []string{"10.1.0.2/31",
			"2002:db8:85a3::370:0001/64"},
		DummyIfs: []DummyIf{
			{"dummy0", "10.6.6.6"},
		...
		Remotes: []string{"10.1.0.0", "10.5.5.5",
			"2001:db8:85a3::370:0002", "2222:db8:85a3::370:0001"},
	},
	{
		NetPort: "net1port1",
		Netns:   "r",
		Ifa:     "10.1.0.3/31",
		Ifas: []string{"10.1.0.3/31",
			"2002:db8:85a3::370:0002/64"},
		Routes: []Route{
			{"10.6.6.6", "10.1.0.2"},
	...
	},
	{
		...
		Netns:   "h1",
		Ifa:     "10.2.0.0/31",
		Ifas: []string{"10.2.0.0/31",
			"3001:db8:85a3::370:0001/64"},
		Routes: []Route{
		...
		Remotes: []string{"10.2.0.2",
			"3002:db8:85a3::370:0001"},
	},
	{
		NetPort: "net2port1",
		Netns:   "r",
		Ifa:     "10.2.0.1/31",
		Ifas:    []string{"10.2.0.1/31", "3001:db8:85a3::370:0002/64"},
		Routes: []Route{
			{"10.5.5.5", "10.2.0.0"},
	...
	},
	{
		...
		Netns:   "h2",
		Ifa:     "10.2.0.2/31",
		Ifas: []string{"10.2.0.2/31",
			"3002:db8:85a3::370:0001/64"},
		Routes: []Route{
		...
		Remotes: []string{"10.2.0.0",
			"3001:db8:85a3::370:0001"},
	},
	{
		NetPort: "net3port1",
		Netns:   "r",
		Ifa:     "10.2.0.3/31",
		Ifas: []string{"10.2.0.3/31",
			"3002:db8:85a3::370:0002/64"},
		Routes: []Route{
